...
bootstrapControllers
    .controller('FunctionsController',['$scope', '$http', '$q', 'Notification', '$animate','FunctionMock',
        function($scope, $http, $q, Notification, $animate, FunctionMock) {
            ...
            $scope.selectFunction = function (functionn) {
                $scope.loading = true;
                FunctionMock.get({functionId: functionn.id}, function(res){
            ...
            $scope.saveFuntion = function() {
                ...
                //    Function.update({functiondId: $scope.selectedFunction.id}, $scope.selectedFunction, function(value) {
